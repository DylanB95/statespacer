...
#'   from `self_spec_list` as passed on to `statespacer()`. If some system
#'   matrices are time-varying then you should specify this argument. See
#'   `statespacer()` for details about the format that must be followed for
#'   this argument.
