...
The object returned by `StateSpaceFit()` exhibits many other useful items. For more information about these items, please see the documentation. For more exhibitions of the statespacer package, please see <https://github.com/DylanB95/statespacer>.
